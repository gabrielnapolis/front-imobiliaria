            ...
            <div className="row">
               <div className={`col-lg-6 wow fadeInLeft ${style ? "col-xxl-5" : ""}`}>
                  <div className="title-one mb-45 lg-mb-30">
                     <h3 className="text-white">Exclusivo <span>Mensal {style ? "" : <Image src={titleShape} alt="" className="lazy-img" />}</span>Deal for you.</h3>
                     <p className="fs-24 text-white pe-xl-5 me-xxl-5">Oferta exclusiva.</p>
                  </div>
                     ...
                     <div className="row gx-0">
                        <div className="col-md-5 d-flex">
                           <div className="gutter border-right w-100 h-100">
                              <div className="tag mb-20">Venda</div>
