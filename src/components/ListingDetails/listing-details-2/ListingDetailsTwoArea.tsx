        ...
        <div className="bg-white shadow4 border-20 p-40 mt-70 lg-mt-50 mb-60">
         ...
         <div className="col-lg-6">
            ...
            <div className="d-flex flex-wrap mt-10">
               <div className="list-type text-uppercase mt-15 me-3 bg-white text-dark fw-500text-uppercase border-20">{property.status}</div>
               <div className="address mt-15"><i className="bi bi-geo-alt"></i> {property.streetAdress}
               </div>
            </div>
         </div>
         <div className="col-lg-6 text-lg-end">
            <div className="d-inline-block md-mt-40">
               <div className="price color-dark fw-500">Preço:{formatPrice(property.price)}</div>
          ...
          <div className="property-feature-list border-top mt-70 lg-mt-50 pt-60 lg-pt-30 pb-30 lg-pb-10">
            ...
            <li>
               ...
               <span className="fs-20 color-dark">Quartos . {property.bed}</span>
            </li>
            <li>
               <Image src={icon_3} alt="" className="lazy-img icon" />
               <span className="fs-20 color-dark">Banheiros . {property.bath}</span>
            </li>
            <li>
               <Image src={icon_4} alt="" className="lazy-img icon" />
               <span className="fs-20 color-dark">Cozinha . {property.kitchen}</span>
            </li>
            <li>
               <Image src={icon_5} alt="" className="lazy-img icon" />
               <span className="fs-20 color-dark">Tipo . {property.propertyType}</span>
            </li>
          ...
          <div className="col-xl-8">
            ...
            <div className="property-feature-accordion bg-white shadow4 border-20 p-40 mb-50">
              ...
              <div className="accordion-style-two mt-45">
                <CommonPropertyFeatureList params={{
                  property: property
                }}/>
              </div>
            </div>
